...
<head>
  ...
  ga('create', 'UA-4128171-19', 'ibewegung.de');
  ga('send', 'pageview');

  </script>
  <!-- FIN ANALYTICS -->
  <!--
  <script type="text/javascript" src="//use.typekit.net/orf1jch.js"></script>
...
<!-- End Facebook like box -->
  ...
  <div id="page-wrapper"><div id="page">
    ...
    if (drupal_is_front_page()) 
      include_once("sites/all/themes/zenibewegung/blocks/anythingslider.php"); ?>
